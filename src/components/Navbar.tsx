...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/60 rounded-b-2xl shadow-md transition-all">
      ...
      {isOpen && (
        <motion.div 
          ...
          className="md:hidden bg-white/95 backdrop-blur-md rounded-b-2xl border-t border-slate-100 px-6 py-5 space-y-4"
        >
